                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="mt-3 text-xs sm:text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                          Worked on system administration tasks, basic
                          networking, and troubleshooting. This experience gave
                          me a strong foundation in how infrastructure and
                          operating systems behave under real workloads.
                        </p>
                      </div>
                    </div>
                  </motion.div>
                ...
                <div className="grid gap-5 md:grid-cols-2">
                    ...
                    <div>
                      ...
                      <ul className="mt-4 space-y-2 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                        ...
                        <li>
                          ...
                          answer submission, scoring, and detailed attempt
                          review.
                        </li>
                        <li>
                  ...
                  >
                    <div>
                      ...
                      <ul className="mt-4 space-y-2 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                        <li>
                          • Built Google OAuth-only authentication using
                          Supabase Auth with secure callback handling.
                        </li>
                        <li>
                        ...
                        <li>
                          • Added realtime bookmark syncing across tabs so
                          changes appear without requiring a manual refresh.
                        </li>
                        <li>
