...
export default function GithubProfileSection({ defaultUsername = "rahul-kapgate" }) {
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-400 max-w-2xl">
              Quickly peek at a public GitHub profile – repos, followers, and how long
              they&apos;ve been coding in the open.
            </p>
          </div>
