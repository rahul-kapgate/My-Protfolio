...
const proof = [
  ...
  { value: "25%", label: "reduced development effort" },
  { value: "20%", label: "faster response times" },
];

const stack = ["React / Next.js", "Node / FastAPI", "PostgreSQL", "AWS"];
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col justify-center px-5 py-24 sm:px-8 lg:px-12">
        ...
        >
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-sm text-zinc-600">Based in Bengaluru, India.</p>
          </div>
        ...
        <div
          className={`mt-8 grid max-w-6xl gap-5 border-y border-white/[0.07] py-5 transition-all delay-500 duration-700 sm:grid-cols-[1fr_auto] sm:items-center ${
            isReady ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"
          }`}
        >
          <div className="flex flex-wrap gap-x-5 gap-y-2">
            {stack.map((item) => (
              <span key={item} className="font-mono text-[10px] text-zinc-600 sm:text-xs">
                {item}
              </span>
            ))}
          </div>
        ...
        <div
          className={`mt-8 hidden items-center justify-between transition-all delay-[600ms] duration-700 sm:flex ${
            isReady ? "translate-y-0 opacity-100" : "translate-y-3 opacity-0"
          }`}
        >
          <div className="flex items-center gap-5">
            <a href="https://github.com/rahul-kapgate" target="_blank" rel="noopener noreferrer" className="text-xs text-zinc-600 transition hover:text-zinc-300">GitHub</a>
            <a href="https://linkedin.com/in/rahul-kapgate" target="_blank" rel="noopener noreferrer" className="text-xs text-zinc-600 transition hover:text-zinc-300">LinkedIn</a>
            <a href="/rahul-kapgate-resume.pdf" target="_blank" rel="noopener noreferrer" className="text-xs text-zinc-600 transition hover:text-zinc-300">Resume</a>
          </div>
